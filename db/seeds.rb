...
'As a New Product Innovation (NPI) graduate, you’ll be sketching, prototyping, testing, failing and refining to deliver the high standards of product development Dyson is known for, working on ideas that will disrupt and transform markets. You’ll need to be thoroughly hands-on, practically applying your technical knowledge with a creative flair to ensure that all engineering problems are resolved thoroughly.',
...
'Kortext has seen significant growth in the last 12 months and this role is key to driving our expansion by continuing to build on this success. This varied role will help develop strong relationships with internal stakeholders supporting with all aspects of HR from recruitment to onboarding. Reporting into the HR Director this role requires an enthusiastic HR assistant looking for a challenge and growth in an exciting company. Learning from an experienced team this role would be perfect for a graduate or someone looking to take their first steps into the world of HR and Recruitment.',
...
'KT Media Recruitment is looking for a Business Development Consultant to join a fast growing technology company who is the leading provider of global legal information, delivered through intelligent technologies and solutions. My client is looking for high achievers with a passion for sales and technology to join their rapidly expanding business development team. This is a remote role, and you will report directly to the Head of Business Development - Global Markets and form part of their UK based team.' ,
